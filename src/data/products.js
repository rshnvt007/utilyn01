...
export const cartItems = [
  {
    id: 'sculptural-o-vase',
    category: 'ARTISAN CERAMICS',
    name: 'The Sculptural O-Vase',
    description:
...
export const completeTheAtelier = [
  {
...
export const bestsellingThemes = ['Nordic Earth', 'Terracotta Minimal', 'The Industrial Loft']
